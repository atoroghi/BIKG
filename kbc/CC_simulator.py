    ...
    for cov_anchor in cov_anchors:
        for cov_var in cov_vars:
            for cov_target in cov_targets:
                ...
                command = ["python3", "-m", "kbc.cqd_beam_bpl", "data/LastFM", "--model_path", "models/LastFM-SimplE-model-rank-100-epoch-80-1686020763.pt", "--dataset", "LastFM", "--candidates", "10", "--quantifier", "marginal_ui", "--cov_target", str(cov_target), "--cov_var", str(cov_var), "--cov_anchor", str(cov_anchor)]
