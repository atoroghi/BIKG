...
if __name__ == '__main__':
    ...
    experiment_name = '1_2_marginal_inst_new'
    chain_type = '1_2'
    ...
    for cov_anchor in cov_anchors:
        for cov_var in cov_vars:
            for cov_target in cov_targets:
                ...
                command = ["python3", "-m", "kbc.cqd_beam_bpl", "data/LastFM_twohop", "--model_path", "models/LastFM_twohop-SimplE-model-rank-50-epoch-40-1691706573.pt", "--dataset", "LastFM_twohop", "--candidates", "1", "--quantifier", "marginal_i", "--cov_target", str(cov_target), "--cov_var", str(cov_var), "--cov_anchor", str(cov_anchor), "--chain_type", str(chain_type), '--mode', 'valid']
